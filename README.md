...
- `assets/images/za-final-logo.png` contains the previous gold Z&A logo image.
- `assets/images/ag-logo.png` contains the current main logo used on the envelope, details screen, and final screen.
